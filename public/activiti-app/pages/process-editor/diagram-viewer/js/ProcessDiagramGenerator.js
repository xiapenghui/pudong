...
var ProcessDiagramGenerator = {	
	...
	generateDiagram: function(processDefinitionDiagramLayout){
        ...
        var processDefinitionName = processDefinitionDiagramLayout.processDefinition.name;
        $("#breadCrumbsItem").html("<span>"+processDefinitionName+"</span>");
		...
		var cnt = 0;
		if (laneSets)
			for(var i = 0; i < laneSets.length; i++){
	...
	// Load processDefinition
     ...
     drawModelDiagram: function(modelId) {
         // Hide all diagrams
         var diagrams = $("#" + this.options.diagramHolderId + " div.diagram");
         diagrams.addClass("hidden");
         this._drawDiagram.apply({processDefinitionId: modelId});
     },
