...
var ICON_SIZE = 16;
var ICON_PADDING = 4;
var USERTASK_IMAGE = 		"./process-editor/diagram-viewer/images/deployer/user.png";
var SCRIPTTASK_IMAGE = 		"./process-editor/diagram-viewer/images/deployer/script.png";
var SERVICETASK_IMAGE = 	"./process-editor/diagram-viewer/images/deployer/service.png";
var RECEIVETASK_IMAGE = 	"./process-editor/diagram-viewer/images/deployer/receive.png";
var SENDTASK_IMAGE = 		"./process-editor/diagram-viewer/images/deployer/send.png";
var MANUALTASK_IMAGE = 		"./process-editor/diagram-viewer/images/deployer/manual.png";
var BUSINESS_RULE_TASK_IMAGE = "./process-editor/diagram-viewer/images/deployer/business_rule.png";
var TIMER_IMAGE = 			"./process-editor/diagram-viewer/images/deployer/timer.png";
var MESSAGE_CATCH_IMAGE = 	"./process-editor/diagram-viewer/images/deployer/message_catch.png";
var MESSAGE_THROW_IMAGE = 	"./process-editor/diagram-viewer/images/deployer/message_throw.png";
var ERROR_THROW_IMAGE = 	"./process-editor/diagram-viewer/images/deployer/error_throw.png";
var ERROR_CATCH_IMAGE = 	"./process-editor/diagram-viewer/images/deployer/error_catch.png";
var SIGNAL_CATCH_IMAGE = 	"./process-editor/diagram-viewer/images/deployer/signal_catch.png";
var SIGNAL_THROW_IMAGE = 	"./process-editor/diagram-viewer/images/deployer/signal_throw.png";
var MULTIPLE_CATCH_IMAGE = 	"./process-editor/diagram-viewer/images/deployer/multiple_catch.png";
		...
		*/
		...
		polyClone.click(function(){
			...
			if (contextObject) {
                ...
                if (ProcessDiagramGenerator.options && ProcessDiagramGenerator.options.on && ProcessDiagramGenerator.options.on.click) {
                    var args = [___canvas, object, contextObject];
                    ProcessDiagramGenerator.options.on.click.apply(event, args);
                }
			}
		}).dblclick(function(){
...
//		下面是改过的代码：
		// 没行只能显示8个汉子，或16个字母
		function isChinese(singleStr){
			var c = singleStr.charCodeAt(0); 
		...
		function format(text, maxSum){
			var layouts= [];
			if(checksum(text) <= maxSum){
				layouts.push(text);
			}
			else{
				var count = 0;
				...
				for(var i = 0; i < text.length; i++){
					...
					if(isChinese(singleStr)){
						...
						if(count > maxSum){
							...
							layout = layout.concat(singleStr);
						}
					}
					else{
						count += 1;
		...
		var maxSum = 16;
		measurer.rafaelTextObject.attr({"text": format(text,maxSum)});
