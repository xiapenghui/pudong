		...
		$.extend(true,this,{
	            ...
	            $itemLi : $('<li id="">\
								<a href="" data-rel="colorbox">\
									<img src="" onerror="this.src=\'/common-assets/plugins/outdated/webuploader-ext/profile-pic.jpg\'"/>\
									<div class="text">\
										<div class="inner"></div>\
									</div>\
								</a>\
...
// });
	...
	widget.webuploader.defaults={
		swf: '/common-assets/plugins/outdated/webuploader-0.1.5/Uploader.swf',
		pick: {
            id: '#input-upload',
            label: '点击选择文件'
        },
