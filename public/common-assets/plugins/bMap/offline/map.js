...
(function() {
    ...
    z.UU = z.apiLoad || function() {
        //*
        z.version && z.version >= 1.5
        //以下为验证
        /*&& pa(z.Ac + "?qt=verify&ak=" + qa, function (a) {
			if (a && a.error !== 0) {
        ...
        mI: function(a) {
            ...
            for (var g = 0; g < c; g++) {
                ...
                if (!i.$H && !(i.mp && !this.map.Vb() || i.jM && this.map.Vb())) {
                    ...
                    var C = this.vg, w = -this.RJ.lng / t, y = this.RJ.lat / t, t = [Math.ceil(w), Math.ceil(y)], f = d.fa(), A;
                    for (A in C) {
                        var D = C[A]
                          , B = D.info;
                ...
                for (var c = p, c = "2" == z.Ny ? [z.url.proto + z.url.domain.main_domain_cdn.other[0] + "/"] : [z.url.proto + z.url.domain.main_domain_cdn.baidu[0] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[1] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[2] + "/"], d = 0, e; e = this.Jm[d]; d++)
                    if (e.f_ == o) {
                        ...
                        e.getTilesUrl = function(b, d) {
                            ...
                            l = window.offmapcfg.tiles_self + d + "/" + e + "/" + k + ".png";
                            return l;
                        }
                        ;
                        break
    ...
    Zc.getTilesUrl = function(a, b, c) {
        var d = a.x
          ...
          , c = Yc[c];
        //普通地图
        var tdir = offmapcfg.tiles_dir.length > 0 ? offmapcfg.tiles_dir : offmapcfg.home + "tiles";
        /*guoguo 使用本地的瓦片 */
        tdir = tdir + "/" + b + "/" + d + "/" + a + offmapcfg.imgext;
        /*guoguo 使用本地的瓦片 */
        my_log('普通地图:' + tdir);
        return tdir;
        /*
    ...
    ad.getTilesUrl = function(a, b) {
        var c = a.x
          , d = a.y;
        var tdir = offmapcfg.tiles_hybrid.length > 0 ? offmapcfg.tiles_hybrid : offmapcfg.home + "tiles_hybrid";
        /*guoguo 使用本地卫星的瓦片 */
        tdir = tdir + "/" + b + "/" + c + "/" + d + offmapcfg.imgext;
        /*guoguo 使用本地卫星的瓦片 */
        my_log('卫星底图:' + tdir);
        return tdir;
        /*说明：
    ...
    Ne.prototype = {
        ...
        $u: function(a) {
            if (!(Be && 0 !== a.touches.length)) {
                var b = this, c = Be ? a.changedTouches[0] : a, d, e, f = {
                    Ba: 0,
                    time: 0
                }, g = {
                    Ba: 0,
