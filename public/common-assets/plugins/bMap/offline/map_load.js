...
var offmapcfg = {
  ...
  'tiles_dir'   : offlineMapBase + '/tile/',       //普通瓦片图的地址，为空默认在 offlineemap/tiles/ 目录
  'tiles_hybrid': offlineMapBase + '/it/',       //卫星瓦片图的地址，为空默认在 offlineemap/tiles_hybrid/ 目录
  'tiles_self'  : offlineMapBase + '/custom/'        //自定义图层的地址，为空默认在 offlineemap/tiles_self/ 目录
};
