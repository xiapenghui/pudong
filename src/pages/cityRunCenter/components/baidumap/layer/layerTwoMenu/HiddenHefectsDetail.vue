<template>
  <div>
    <div class="boxmune" :style="{width:'400px',height:'400px',top:'120px'}" v-show="isShow==true">
      <h4>
        {{title}}
        <i @click="closeFn"></i>
      </h4>
...
export default {
  ...
  mounted() {
    eventBus.on("graphic-clickTwoMenu-HiddenHefectsDetail", this.clickMenuTips); //监听图层tips按钮
  }
};
</script>
