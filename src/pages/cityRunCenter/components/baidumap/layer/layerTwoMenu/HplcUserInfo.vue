<template>
  <div>
    <div class="boxmune" :style="{width:'540px',height:'581px',top:'65px'}" v-show="isShow==true">
      <h4>
        {{title}}
        <i @click="closeFn"></i>
      </h4>
...
export default {
  ...
  mounted() {
    eventBus.on("showVue-HplcUserInfo", this.clickMenuTips); //打开图片
  }
};
</script>
...
.boxmune {
  ...
  background-image: url(../../assets/images/menuTips/ic_HplcUserInfo.png);
