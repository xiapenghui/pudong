...
function PowerStationLayer35kv() {//电站-35kv
    return {
        data() {
            return {};
        },
        ...
        watch: {
            ready: function () {
                ...
                this.eventBus.on("layer-data-PowerStationLayer35kvService", this.PowerStation);//通过10kv图层拿数据
                this.eventBus.on("graphic-flyShowTips-PowerStationLayer35kv", this.flyShowTips);//定位tips弹框
        ...
        methods: {
            PowerStation(list) {//图层渲染
                ...
                for (let i = 0; i < data.length; i++) {
                    ...
                    if (data[i].voltage == "交流35kV" || data[i].voltage == "直流35kV") {
                            ...
                            new Graphic({
                                ...
                                feature: new Feature({
                                    ...
                                    geometry: new Point({
                                        ...
                                        coordinates: [data[i].jd, data[i].wd]//转换后的坐标
                                    }),
            ...
            graphicClickHandler({ pixel, point, graphic, map }) {//点击tips信息
                let itme = {
                    layerName: "PowerStationLayer35kv",//图层名称
                    title: "电站",//tips标题
                    type: "",//tips展示类型
                    data: [//tips数据 
...
export default VectorLayer.extend(PowerStationLayer35kv());
