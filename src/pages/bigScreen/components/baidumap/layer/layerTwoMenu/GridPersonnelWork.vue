<template>
  <div>
    <div class="boxmune" :style="{width:'400px',height:'280px',top:'120px'}" v-show="isShow==true">
      <h4>
        {{title}}
        <i @click="closeFn"></i>
      </h4>
...
export default {
  ...
  mounted() {
    eventBus.on("graphic-clickTwoMenu-GridPersonnelWork", this.clickMenuTips); //监听图层tips按钮
  }
};
</script>
