...
import LineFz2Data from "./LineFz2Data"//线数据-伦25东捷张江甲
import {wgs2bd} from "../../utils/Convert";//坐标转换

function LineFz2Layer() {
    return {
        data() {
            return {};
        },
        ...
        watch: {
            ready: function () {
                ...
                this.eventBus.on("layer-visible-LineFz2Layer", this.onLayerVisible);//图层显示隐藏监听

                let data = LineFz2Data;//线数据
                let wgs2bdData=[];
...
export default VectorLayer.extend(LineFz2Layer());
