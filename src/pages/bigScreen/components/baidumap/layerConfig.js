export default [
    ...
    //网格化运维人员热力图
    {
        className: "GridPersonnelHeatLayer",
        name: "GridPersonnelHeatLayer",
        alias: "网格化运维人员热力图",
        visible: false,
        minVisibleZoom: 0,
        maxVisibleZoom: 2,
    ...
    //保电井盖
    {
        className: "IntelligentCoverBdLayer",
        name: "IntelligentCoverBdLayer",
        alias: "保电井盖",
        visible: false,
        minVisibleZoom: 4,
        maxVisibleZoom: 10,
    ...
    //通道监拍
    {
        className: "ChannelMonitoringLayer",
        name: "ChannelMonitoringLayer",
        alias: "通道监拍",
        visible: true,
        minVisibleZoom: 4,
        maxVisibleZoom: 10,
        ...
        renderer: {
            ...
            defaultSymbol: {
                type: "pictureMarker",
                url: require('./assets/images/marker/ic_tdjp.png'),
                angle: 0,
                height: 36,
                width: 36,
                xoffset: 0,
    ...
    //通道监拍-保电
    {
        className: "ChannelMonitoringBdLayer",
        name: "ChannelMonitoringBdLayer",
        alias: "通道监拍-保电",
        visible: false,
        minVisibleZoom: 4,
        maxVisibleZoom: 10,
    ...
    //弹框图层1
    {
        className: "OpenDialog1Layer",
        name: "OpenDialog1Layer",
        alias: "弹框图层1",
        visible: true,
        minVisibleZoom: 0,
        maxVisibleZoom: 0,
    ...
    //坐标定位点
    {
        className: "FlyPointBdLayer",
        name: "FlyPointBdLayer",
        alias: "坐标定位点",
        visible: false,
        minVisibleZoom: 0,
        maxVisibleZoom: 10,
        ...
        renderer: {
            ...
            defaultSymbol: {
                type: "pictureMarker",
                url: require('./assets/images/marker/ic_fly_point.png'),
                angle: 0,
                height: 36,
                width: 36,
                xoffset: 0,
    ...
    //保电对象-东郊宾馆
    {
        className: "ProtectionObjectBdLayer",
        name: "ProtectionObjectBdLayer",
        alias: "保电对象",
        visible: false,
        minVisibleZoom: 4,
        maxVisibleZoom: 10,
